...
export default function CatForm(props) {
    const handleSubmit = (values) => {
        ...
        if(!props.category){
            ...
            axios.post(`http://todoapi.colsondonnerdev.com/api/categories`, catToCreate).then(() => {
            ...
            axios.put(`http://todoapi.colsondonnerdev.com/api/categories/${props.category.categoryId}`, catToEdit).then(() => {
